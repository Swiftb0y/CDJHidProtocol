...
after that (blue) have not yet been understood, they seem to be changing between
devices (see table below). Afterwards, the inner data follows which is
...
.vendor-device device ID
[options="header"]
|===
|               |     device ID    |   

| *DJM250MK2*   | `0x0000001700` |
| *DJM750MK2*   | `0x0000010B00` |
|===
